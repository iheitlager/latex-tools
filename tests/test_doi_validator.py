...
from latex_tools.cli.doi_validator import DOICache, DOIValidator
...
class TestDOICache(unittest.TestCase):
    ...
    def test_cache_is_valid_expired(self):
        ...
        cache.cache[doi] = {"is_valid": True, "timestamp": old_timestamp}
        cache._save_cache()
...
class TestBibTeXParsing(unittest.TestCase):
    ...
    issn = {13676261}
        ...
        self.assertEqual(
            validator.entries["Hodkinson2005"]["doi"], "10.1080/13676260500149238"
        )
        self.assertEqual(validator.entries["Hodkinson2005"]["entry_type"], "article")
...
@article{VanOorschot2015,
    ...
    doi = {10.1057/978-1-349-94848-2{\\_}390-1}
        ...
        self.assertEqual(
            validator.entries["TestBook"]["doi"], "10.1057/978-1-349-94848-2_390-1"
        )
    ...
    doi = {10.1234/{_}test}
        ...
        # Verify {_} is cleaned
        self.assertEqual(validator.entries["TestBook2"]["doi"], "10.1234/_test")
    ...
    doi = {10.1234/test{code}123}
        ...
        self.assertEqual(validator.entries["TestBook3"]["doi"], "10.1234/testcode123")
    ...
    doi = {10.1007/978-3-642-29863-9}
        ...
        self.assertEqual(
            validator.entries["Venable2012"]["entry_type"], "inproceedings"
        )
        self.assertEqual(
            validator.entries["Venable2012"]["doi"], "10.1007/978-3-642-29863-9"
        )
    ...
    doi = {10.1234/phd.thesis}
        ...
        self.assertEqual(validator.entries["Valdez1989"]["entry_type"], "phdthesis")
    ...
    DOI = {10.1234/test.case}
        ...
        self.assertEqual(validator.entries["TestDOI"]["doi"], "10.1234/test.case")
