...
from latex_tools.cli.latex_processor import LaTeXProcessor
...
"""
        ...
        self.assertEqual(
            garcia_entry["author"],
            'Garcia Martin, Patricia Carolina and Sj{\\"{o}}din, David and Nair, Sujith and Parida, Vinit',
        )
    ...
    def test_apa_author_formatting(self):
        ...
        # Multiple authors
        result = processor._format_authors_apa(
...
class BibtItemParsing(unittest.TestCase):
    ...
    def test_short_author_names(self):
        ...
        authors = [
            ...
            (
                "Warner, Karl S.R. and Waeger, Maximilian",
                2019,
    ...
    def test_apa_formating_warner(self):
        ...
        self.assertTrue(
            warner_entry["author"] == "Warner, Karl S.R. and Waeger, Maximilian"
        )
...
"""
        ...
        self.assertEqual(
            captions["fig:with_caption"]["caption"], "This one has a caption"
        )
