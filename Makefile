...
test: test-py ## Run unit test suite with coverage (Python + JavaScript)

test-py: ## Run unit test suite with coverage (Python)
	@echo "Running Python tests with coverage..."
	uv run pytest --cov=src/ tests/
	@echo "✓ Python tests completed. Coverage report generated in htmlcov/index.html"
...
format: ## Format and autofix code with ruff
